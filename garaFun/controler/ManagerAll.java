...
public class ManagerAll extends FactoryStaff implements RepairedCarNumber {
...
//        controler.FactoryStaff staffFactory = new FactoryStaff();
...
//       listStaff.add(staff);
    ...
    public void updateSalary(Staff staff, int newSalary) {
        Staff staffForUpdate = listStaff.stream()
                .filter(staff1 -> staff1.getCodeStaff() == staff.getCodeStaff())
                .findFirst()
                .get();
